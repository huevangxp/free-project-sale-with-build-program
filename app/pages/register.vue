...
async function submit() {
  error.value = auth.register(name.value, phone.value, password.value) ?? "";
  if (!error.value) {
...
<template>
  <div class="mx-auto flex max-w-md flex-col px-4 py-12">
    <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100 sm:p-8">
      <h1 class="text-center text-2xl font-bold text-gray-800">ລົງທະບຽນ</h1>
      <p class="mt-1 text-center text-sm text-gray-500">
        ສ້າງບັນຊີໃໝ່ ເພື່ອສັ່ງຊື້ໄດ້ງ່າຍ ແລະ ໄວຂຶ້ນ
      </p>
