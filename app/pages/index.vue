...
<template>
  <div>
    <!-- Hero -->
    <section
      class="bg-linear-to-br from-primary-800 via-primary-700 to-primary-600 text-white"
    >
      <div
        class="mx-auto flex max-w-6xl flex-col items-center gap-6 px-4 py-16 text-center sm:py-24"
      >
        <span
