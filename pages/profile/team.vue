<template>
  <div class="px-2 my-4">
    <v-card elevation="3" rounded="xl" class="d-flex align-center">
      <v-card-title>
        <v-img
          src="https://img.freepik.com/premium-photo/portrait-serious-african-guy-looking-camera_116547-37326.jpg?semt=ais_hybrid&w=740"
          height="150"
          width="120"
          cover
        ></v-img>
      ...
      <div>
        <v-card-text>
          <h2
            class="text-primary d-flex align-center justify-space-between"
            style="width: 100%"
          >
            <div>ທ່ານ ລີຟອງ ວ່າງ</div>
          </h2>
